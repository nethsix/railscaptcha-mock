...
def parse(input_filename, output_filename):
    ...
    for i, line in enumerate(input_fh):
        ...
        line = line.replace("0000-00-00 00:00:00", "1900-01-01 03:52:17")
        line = line.replace("float(", "numeric(")
        ...
        if current_table is None:
            ...
            # Inserting data into a table?
                ...
                output.write(line.encode("utf8").replace("'1900-01-01 03:52:17'", "'1900-01-01 03:52:17'") + "\n")
                num_inserts += 1
            # ???
            else:
